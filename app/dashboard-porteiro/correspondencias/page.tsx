    ...
    <div className="space-y-5">
      <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-5 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
          <div>
            <label htmlFor="filtro-port-data-inicio" className="text-xs font-bold text-gray-500 ml-1 mb-1 block">Data Inicial</label>
            <input
              id="filtro-port-data-inicio"
              type="date"
          ...
          <div>
            <label htmlFor="filtro-port-data-fim" className="text-xs font-bold text-gray-500 ml-1 mb-1 block">Data Final</label>
            <input
              id="filtro-port-data-fim"
              type="date"
              className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm"
              value={dataFim}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="filtro-port-bloco" className="text-xs font-bold text-gray-500 ml-1 mb-1 block">Filtrar por Bloco</label>
            <select
              id="filtro-port-bloco"
          ...
          <div>
            <label htmlFor="filtro-port-unidade" className="text-xs font-bold text-gray-500 ml-1 mb-1 block">Filtrar por Unidade</label>
            <select
              id="filtro-port-unidade"
              className="w-full px-3 py-2.5 border border-gray-200 rounded-xl bg-white text-sm"
              value={filtroUnidade}
